...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_DVORAK] = LAYOUT(
      KC_GRV , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   , KC_F3  ,     KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_SLSH, KC_BSLS,
      KC_TAB , KC_QUOT, KC_COMM, KC_DOT , KC_P   , KC_Y   , KC_F6  ,     KC_F   , KC_G   , KC_C   , KC_R   , KC_L   , KC_MINS, KC_EQL ,
      ...
      MO(_FN)       , KC_LALT    , KC_SPC   , SYM_SPC     , KC_ESC ,     BS_SFT , KC_ENT , KC_ENT     , KC_RGUI
  ),
